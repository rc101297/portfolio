      ...
      <div class="grid md:grid-cols-3 gap-8 mb-8">
        <div>
          ...
          <p class="text-gray-400 leading-relaxed">
            Junior Full-Stack Developer passionate about creating beautiful and functional web
            applications.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <div class="flex space-x-4">
            <a
              href="mailto:rowenacornejo.work@gmail.com"
            ...
            <a
              href="https://www.linkedin.com/in/rowena-cornejo"
              class="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors duration-300"
              aria-label="LinkedIn"
            >
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="https://github.com/rc101297"
              class="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors duration-300"
              aria-label="GitHub"
            >
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="border-t border-gray-800 pt-8">
        <div class="flex flex-col md:flex-row justify-between items-center">
          <p class="text-gray-400 text-sm">
            © {{ currentYear }} Rowena Cornejo. All rights reserved.
          </p>
